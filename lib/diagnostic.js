...
// your code begins here
db.houses.update({House: "Stark"}, {$set: {members: ['Ned Stark', 'Arya Stark',
  'Sansa Stark', 'Viserys Targaryen', 'Daenerys Targaryen', 'Jon Arryn']} })
// your code ends here
...
// your code begins here
db.Houses.update({House: "Arryn"}, {$unset: {motto: ""}})
// your code ends here
