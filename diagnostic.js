...
// your code begins here
db.houses.update({name:"House Stark"}, {$push: {members:  {$each:["Ned Stark", "Arya Stark", "Sansa Stark"]}}})
db.houses.update({name:"House Targaryen"}, {$push: {members:  {$each:["Viserys Targaryen", "Daenerys Targaryen"]}}})
